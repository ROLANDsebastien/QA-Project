...
const ConfirmDialog = ({
  ...
  return createPortal(
    <div
      ...
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gradient-to-br from-primary/30 to-primary-dark/40 backdrop-blur-md animate-fadeIn"
    >
      <div
        ref={dialogRef}
